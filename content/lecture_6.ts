export default {
   ...
   test: [
      ...
      {
         question: "Каков результат вызова функции outerFunction() в примере замыкания?",
         options: [
            {
               answer: "Ошибка: outerVariable is not defined.",
               isCorrect: false
            },
            {
               answer: "Ошибка: innerFunction is not defined.",
               isCorrect: false
            },
            {
               answer: "Выводится значение переменной outerVariable из функции outerFunction.",
               isCorrect: true
            },
            {
               answer: "Выводится значение переменной innerVariable из функции innerFunction.",
               isCorrect: false
            }
         ]
      }
